        ...
        <div class="overflow-y-auto">
            ...
            <div class="px-4 py-6 space-y-2">
                ...
                @if(Auth::user()->role === 'admin')
                    ...
                    <!-- BARIS BARU: Menu Manajemen Penarikan Dana -->
                    <a href="{{ route('admin.withdrawals.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-2xl transition-all duration-200 {{ request()->routeIs('admin.withdrawals.*') ? 'bg-emerald-50 text-emerald-600 font-bold shadow-sm border border-emerald-100' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
