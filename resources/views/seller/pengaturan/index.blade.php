                ...
                <div class="p-6 sm:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-6">
                            <div class="w-24 h-24 rounded-2xl bg-gray-50 border border-gray-200 overflow-hidden shrink-0 flex items-center justify-center text-gray-300">
                                @if($umkm->image)
                                    <img src="{{ asset($umkm->image) }}" alt="{{ $umkm->name }}" class="w-full h-full object-cover">
                                @else
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="whatsapp_number" id="whatsapp_number" value="{{ old('whatsapp_number', $umkm->whatsapp_number) }}" placeholder="081234567890" class="w-full rounded-lg border-gray-300 bg-gray-50 border p-2.5 text-sm focus:border-emerald-500 focus:ring-emerald-500 outline-none transition">
                            </div>
